            ...
            <div className="flex  flex-col relative py-8">
                <div className="flex w-full justify-between">
                    ...
                    <div className="flex flex-col items-center justify-center p-4 gap-4 md:flex-row bg-[rgba(255,255,255,.5)] z-[2]">
                        <button className="p-4 shadow-lg bg-white" onClick={() => router.push("/register")}>Login As Voter</button>
                        <button className="p-4 shadow-lg bg-white" onClick={() => router.push("/admin/login")}>Login As Admin</button>
                    </div>
                </div>
                <div className="flex px-4  -ml-2 mt-5 flex-1 w-full h-full max-w-[400px] max-h-[400px] bg-[rgba(0,0,0,.6)] md:-ml-8 flex-col justify-center min-h-[250px]  gap-4 text-white  z-[3] ">
